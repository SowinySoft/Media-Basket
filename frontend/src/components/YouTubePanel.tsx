...
import { ThumbsUp, MessageSquare, Eye, Video, Send, Trash2, Flag, CheckCircle, RefreshCw } from "lucide-react";
...
export default function YouTubePanel({ serviceId, videoId, title, description, stats, onClose }: Props) {
  ...
  return (
    <ServicePanel serviceId={serviceId} connectorType="youtube" title="YouTube Manager" onClose={onClose}>
      {/* Channel Info */}
      {channel && (
